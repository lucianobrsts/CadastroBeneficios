...
/**
 * 
 * Classe com métodos para executar o dump do MySQL. O "bin" do MySQL deve estar
 * no PATH do SO.
 *
 */
public class MySQLDump {
	 ...
	 *
	 * @param arquivo
	 *            Caminho do arquivo que deve ser gerado com a saída da exportação.
	 * @param usuario
	...
	public static void dump(String arquivo, String usuario, String senha, String base, String... tabelas)
		 ...
		 * caso contrário não adiciona, pois pode gerar um arquivo vazio
		 */
		if (senha != "") {
